...
public class ListAdapterMyOrderList extends BaseAdapter {
    ...
    public ListAdapterMyOrderList(List<Order> orderList, Context context) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView==null){
            ...
            listViewOrderedBooks = inflater.inflate(R.layout.row_item_my_order_book, null);
        }
...
//        }
        ...
        if(order.getOrderType()==2){
            ...
            rentDateSection.setVisibility(View.GONE);
            bookLabel.setText("Purchased");
            bookLabel.setBackgroundColor(context.getResources().getColor(R.color.green));
        }
